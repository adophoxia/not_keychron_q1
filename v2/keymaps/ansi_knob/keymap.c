...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    [_M0] = { ENCODER_CCW_CW( KC_VOLD, KC_VOLU ) },
    [_MF] = { ENCODER_CCW_CW( RGB_VAD, RGB_VAI ) },
    [_W2] = { ENCODER_CCW_CW( KC_VOLD, KC_VOLU ) },
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     */
    [_M0] = LAYOUT_ansi(
        KC_ESC,  KC_BRID, KC_BRIU, Q1_MCON, Q1_LPAD, RGB_VAD, RGB_VAI, KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, KC_VOLD, KC_VOLU, KC_DEL,           KC_MUTE,
        KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC,          KC_PGUP,
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS,          KC_PGDN,
        KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,           KC_HOME,
        KC_LSFT,          KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,          KC_RSFT, KC_UP,
        KC_LCTL, Q1_LOPT, Q1_LCMD,                            KC_SPC,                             Q1_RCMD, MO(_MF), KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [_WF] = LAYOUT_ansi(
        _______, KC_BRID, KC_BRIU, Q1_TASK, Q1_FLXP, RGB_VAD, RGB_VAI, KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, KC_VOLD, KC_VOLU, _______,          RGB_TOG,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
        RGB_TOG, RGB_MOD, RGB_VAI, RGB_HUI, RGB_SAI, RGB_SPI, NK_TOGG, _______, _______, _______, _______, _______, _______, _______,          _______,
        _______, RGB_RMD, RGB_VAD, RGB_HUD, RGB_SAD, RGB_SPD, _______, _______, _______, _______, _______, _______,          _______,          _______,
        _______,          QK_BOOT, _______, _______, Q1_VRSN, _______, NK_TOGG, _______, _______, _______, EEP_RST,          _______, _______,
